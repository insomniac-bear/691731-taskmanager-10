...
const createSiteBoardTasksTemplate = () => {
  return (
...
render(siteBoardElement, createSiteBoardTasksTemplate(), `beforeend`);

const taskListElement = siteBoardElement.querySelector(`.board__tasks`);

render(taskListElement, createSiteEditTaskTemplate(), `beforeend`);
